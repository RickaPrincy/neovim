...
vim.api.nvim_set_keymap('n', '<C-Up>', [[:lua require('config.core.utils').window.resize("up")<cr>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-Down>', [[:lua require('config.core.utils').window.resize("down")<cr>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-Left>', [[:lua require('config.core.utils').window.resize("left")<cr>]], { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-Right>', [[:lua require('config.core.utils').window.resize("right")<cr>]], { noremap = true, silent = true })
